...
- **Lockfile:** `examples/lockfiles/malicious-transitive/package-lock.json`
- **Format:** package-lock
- **Scanned:** 2 packages
- **Indicators:** 3,474 from 4 sources
- **Generated:** 2026-08-06T20:35:03.383Z (403ms)

## Findings (1)

| Package | Version | Direct | Detected by | Advisory | Severity | Patched |
| --- | --- | --- | --- | --- | --- | --- |
| `keyv` | `6.0.0` | Transitive via cacheable-request | DataDog keyv-campaign | MAL-2026-11524 | — | — |
